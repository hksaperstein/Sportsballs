...
def load_data():
    ...
    return train_images, test_images, train_labels, test_labels, input_res, num_classes
...
# train_images, test_images, train_labels, test_labels, input_res, num_classes = load_data()
